...
/**
 * *create_buffer - Assign 1024 bytes fo a buffer.
 * @file: The name of the file the buffer is gonna store char.
 *
...
/**
 * main - It copies the content of the first file to the other.
 ...
 * If both file can't be closed - exit code 100.
 */
