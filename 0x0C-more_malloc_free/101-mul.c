...
/**
 * *create_xarray - Create an array of chars and initial with chars 'X'
 * @size: The size of the array to be initialized
 * Describtion: If there is insufficient space the function exits with 98
 ...
 * @str: The string of number to be iterate through
